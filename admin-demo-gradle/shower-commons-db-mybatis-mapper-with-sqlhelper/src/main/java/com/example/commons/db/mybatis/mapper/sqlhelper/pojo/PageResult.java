package com.example.commons.db.mybatis.mapper.sqlhelper.pojo;

import com.example.commons.db.pojo.BaseDbPageResult;
...
@Data
public class PageResult<T> extends BaseDbPageResult<T> {
