...
public class QueueConfiguration {
    ...
    public static final String TOPIC_MESSAGE_01 = "topic.message01";
    public static final String TOPIC_MESSAGE_02 = "topic.message02";
    ...
    public Binding topic_binding_01(@Qualifier(TOPIC_QUEUE_01) Queue queue, TopicExchange exchange) {
        return BindingBuilder.bind(queue).to(exchange).with(TOPIC_MESSAGE_01);
    }

    @Bean(TOPIC_BINDIND_02)
    public Binding topic_binding_02(@Qualifier(TOPIC_QUEUE_02) Queue queue, TopicExchange exchange) {
        return BindingBuilder.bind(queue).to(exchange).with(TOPIC_MESSAGE_02);
    }
