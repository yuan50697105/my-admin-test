package com.example.commons.base.menu.utils;

import cn.hutool.json.JSONUtil;
import com.example.commons.base.menu.pojo.Menu;
import com.example.commons.base.menu.pojo.MenuTree;
...
public class MenuUtils {
    ...
    public static void main(String []args) {
        ...
        /*转为json看看效果*/
        String jsonOutput= JSONUtil.toJsonPrettyStr(menuList);
