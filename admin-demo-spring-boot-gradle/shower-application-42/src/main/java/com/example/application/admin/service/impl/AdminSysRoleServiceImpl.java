...
import com.example.commons.db.mybatis.querydsl.jpa.sqlhelper.module.constants.EnableConstants;
...
public class AdminSysRoleServiceImpl implements AdminSysRoleService {
    ...
    public Result save(AdminSysRoleSaveRequestBody requestBody) {
        ...
        List<SysPermission> sysPermissions = sysPermissionService.selectByPrimaryKeys(requestBody.getPermissionIds());
    ...
    public Result updatePermission(AdminSysPermissionUpdateRequestBody requestBody) {
        ...
        SysRole sysRole = sysRoleService.selectByPrimaryKey(requestBody.getId());
        List<SysPermission> sysPermissions = sysPermissionService.selectByPrimaryKeys(permissionIds);
