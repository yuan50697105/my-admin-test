...
import com.example.commons.db.mybatis.plus.pagehelper.module.pojo.SysRole;
...
import com.example.commons.db.mybatis.plus.pagehelper.module.service.SysRolePermissionService;
...
public class AdminSysRoleServiceImpl implements AdminSysRoleService {
    ...
    public Result save(AdminSysRoleSaveRequestBody requestBody) {
        ...
        List<SysPermission> sysPermissions = sysPermissionService.listByIds(requestBody.getPermissionIds());
    ...
    public Result updateInfo(AdminSysRoleUpdateRequestBody requestBody) {
        SysRole sysRole = sysRoleService.getById(requestBody.getId());
    ...
    public Result delete(List<Long> ids) {
        ...
        sysRolePermissionService.removeByRoleIds(ids);
